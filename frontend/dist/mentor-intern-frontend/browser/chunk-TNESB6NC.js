...
// src/app/interns/intern-list/intern-list.component.ts
function InternListComponent_mat_option_40_Template(rf, ctx) {
  if (rf & 1) {
...
function InternListComponent_mat_option_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-option", 20);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function InternListComponent_div_48_div_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
...
function InternListComponent_div_48_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275template(1, InternListComponent_div_48_div_6_div_1_Template, 2, 1, "div", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r4.uploadResult.errors);
  }
}
function InternListComponent_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, InternListComponent_div_48_div_6_Template, 2, 1, "div", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 23);
    \u0275\u0275listener("click", function InternListComponent_div_48_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.uploadResult = null);
    });
  ...
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275classProp("success", ctx_r4.uploadResult.errorRows === 0)("warning", ctx_r4.uploadResult.errorRows > 0);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r4.uploadResult.errorRows === 0 ? "check_circle" : "warning");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r4.uploadResult.message);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", (ctx_r4.uploadResult.errors == null ? null : ctx_r4.uploadResult.errors.length) > 0);
  }
}
function InternListComponent_div_49_Template(rf, ctx) {
  if (rf & 1) {
...
function InternListComponent_div_50_tr_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 32);
    \u0275\u0275listener("click", function InternListComponent_div_50_tr_21_Template_tr_click_0_listener() {
      const intern_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.viewProfile(intern_r7));
    });
    \u0275\u0275elementStart(1, "td")(2, "div", 33)(3, "div", 34);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div")(6, "div", 35);
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "td")(24, "span", 38);
    \u0275\u0275text(25);
    \u0275\u0275elementEnd();
    \u0275\u0275text(26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "td")(28, "button", 39);
    \u0275\u0275listener("click", function InternListComponent_div_50_tr_21_Template_button_click_28_listener($event) {
      const intern_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      ctx_r4.viewProfile(intern_r7);
    ...
    \u0275\u0275listener("click", function InternListComponent_div_50_tr_21_Template_button_click_31_listener($event) {
      const intern_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      ctx_r4.deleteIntern(intern_r7);
      return \u0275\u0275resetView($event.stopPropagation());
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(intern_r7.name == null ? null : intern_r7.name.charAt(0));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(intern_r7.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(intern_r7.email);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(intern_r7.internId);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(intern_r7.college || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(intern_r7.department || "-");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", \u0275\u0275pipeBind2(18, 12, intern_r7.startDate, "MMM d"), " - ", \u0275\u0275pipeBind2(19, 15, intern_r7.endDate, "MMM d, y"), "");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", "status-" + (intern_r7.status == null ? null : intern_r7.status.toLowerCase()));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(intern_r7.status);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(intern_r7.completedTasks);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" / ", intern_r7.totalTasks, " ");
  }
}
function InternListComponent_div_50_tr_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 41)(2, "mat-icon");
    \u0275\u0275text(3, "people_outline");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
    \u0275\u0275text(5, "No interns found. Upload an Excel file to get started.");
    \u0275\u0275elementEnd()()();
  }
}
function InternListComponent_div_50_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(21, InternListComponent_div_50_tr_21_Template, 34, 18, "tr", 30)(22, InternListComponent_div_50_tr_22_Template, 6, 0, "tr", 31);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance(21);
    \u0275\u0275property("ngForOf", ctx_r4.interns);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r4.interns.length === 0);
  }
}
var InternListComponent = class _InternListComponent {
  constructor(internService, router, snackBar) {
  ...
  onFileUpload(event) {
    ...
    this.internService.uploadExcel(file).subscribe({
      ...
      error: (err) => {
        this.snackBar.open("Upload failed: " + (err.error?.message || "Unknown error"), "Close", { duration: 3e3 });
      }
    });
  }
  viewProfile(intern) {
  ...
  deleteIntern(intern) {
    if (confirm(`Delete intern ${intern.name}?`)) {
      this.internService.delete(intern.id).subscribe(() => {
        this.snackBar.open("Intern deleted", "Close", { duration: 2e3 });
        this.loadInterns();
      });
    }
  }
  static {
    this.\u0275fac = function InternListComponent_Factory(t) {
      return new (t || _InternListComponent)(\u0275\u0275directiveInject(InternService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(MatSnackBar));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _InternListComponent, selectors: [["app-intern-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 51, vars: 9, consts: [[1, "page-container"], [1, "page-header"], [1, "header-row"], [1, "header-actions"], ["matTooltip", "Upload .xlsx file", 1, "upload-btn"], ["type", "file", "accept", ".xlsx,.xls", "hidden", "", 3, "change"], [1, "search-bar"], ["appearance", "outline", 2, "flex", "1", "min-width", "250px"], ["matInput", "", "placeholder", "Name, ID, or email", 3, "ngModelChange", "input", "ngModel"], ["matPrefix", ""], ["appearance", "outline", 2, "width", "160px"], [3, "ngModelChange", "selectionChange", "ngModel"], ["value", ""], ["value", "ACTIVE"], ["value", "COMPLETED"], ["value", "DROPPED"], [3, "value", 4, "ngFor", "ngForOf"], ["class", "upload-result", 3, "success", "warning", 4, "ngIf"], ["class", "loading-state", 4, "ngIf"], ["class", "data-table-container", 4, "ngIf"], [3, "value"], [1, "upload-result"], ["class", "error-list", 4, "ngIf"], ["mat-icon-button", "", 3, "click"], [1, "error-list"], [4, "ngFor", "ngForOf"], [1, "loading-state"], ["diameter", "40"], [1, "data-table-container"], [1, "performance-table"], ["style", "cursor: pointer;", 3, "click", 4, "ngFor", "ngForOf"], [4, "ngIf"], [2, "cursor", "pointer", 3, "click"], [1, "intern-cell"], [1, "intern-avatar"], [1, "intern-name"], [1, "intern-id"], [1, "status-badge", 3, "ngClass"], [1, "text-success"], ["mat-icon-button", "", "matTooltip", "View Profile", 3, "click"], ["mat-icon-button", "", "matTooltip", "Delete", "color", "warn", 3, "click"], ["colspan", "8", 1, "empty-state"]], template: function InternListComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div")(4, "h1");
        \u0275\u0275text(5, "Intern Management");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(6, "p");
        \u0275\u0275text(7, "Manage your intern data, upload Excel files, and track performance");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(8, "div", 3)(9, "label", 4)(10, "mat-icon");
        \u0275\u0275text(11, "cloud_upload");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "span");
        \u0275\u0275text(13, "Upload Excel");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(14, "input", 5);
        \u0275\u0275listener("change", function InternListComponent_Template_input_change_14_listener($event) {
          return ctx.onFileUpload($event);
        });
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(15, "div", 6)(16, "mat-form-field", 7)(17, "mat-label");
        \u0275\u0275text(18, "Search interns...");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(19, "input", 8);
        \u0275\u0275twoWayListener("ngModelChange", function InternListComponent_Template_input_ngModelChange_19_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.searchQuery, $event) || (ctx.searchQuery = $event);
          return $event;
        });
        \u0275\u0275listener("input", function InternListComponent_Template_input_input_19_listener() {
          return ctx.onSearch();
        });
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(20, "mat-icon", 9);
        \u0275\u0275text(21, "search");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275twoWayListener("ngModelChange", function InternListComponent_Template_mat_select_ngModelChange_25_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.statusFilter, $event) || (ctx.statusFilter = $event);
          return $event;
        });
        \u0275\u0275listener("selectionChange", function InternListComponent_Template_mat_select_selectionChange_25_listener() {
          return ctx.onSearch();
        });
        ...
        \u0275\u0275text(36, "Batch");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(37, "mat-select", 11);
        \u0275\u0275twoWayListener("ngModelChange", function InternListComponent_Template_mat_select_ngModelChange_37_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.batchFilter, $event) || (ctx.batchFilter = $event);
          return $event;
        });
        \u0275\u0275listener("selectionChange", function InternListComponent_Template_mat_select_selectionChange_37_listener() {
          return ctx.onSearch();
        });
        \u0275\u0275elementStart(38, "mat-option", 12);
        \u0275\u0275text(39, "All");
        \u0275\u0275elementEnd();
        \u0275\u0275template(40, InternListComponent_mat_option_40_Template, 2, 2, "mat-option", 16);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(41, "mat-form-field", 10)(42, "mat-label");
        \u0275\u0275text(43, "Department");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(44, "mat-select", 11);
        \u0275\u0275twoWayListener("ngModelChange", function InternListComponent_Template_mat_select_ngModelChange_44_listener($event) {
          \u0275\u0275twoWayBindingSet(ctx.deptFilter, $event) || (ctx.deptFilter = $event);
          return $event;
        });
        \u0275\u0275listener("selectionChange", function InternListComponent_Template_mat_select_selectionChange_44_listener() {
          return ctx.onSearch();
        });
        \u0275\u0275elementStart(45, "mat-option", 12);
        \u0275\u0275text(46, "All");
        \u0275\u0275elementEnd();
        \u0275\u0275template(47, InternListComponent_mat_option_47_Template, 2, 2, "mat-option", 16);
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(48, InternListComponent_div_48_Template, 10, 7, "div", 17)(49, InternListComponent_div_49_Template, 2, 0, "div", 18)(50, InternListComponent_div_50_Template, 23, 2, "div", 19);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(19);
        ...
        \u0275\u0275advance(12);
        \u0275\u0275twoWayProperty("ngModel", ctx.batchFilter);
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", ctx.batches);
        \u0275\u0275advance(4);
        \u0275\u0275twoWayProperty("ngModel", ctx.deptFilter);
        \u0275\u0275advance(3);
        \u0275\u0275property("ngForOf", ctx.departments);
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.uploadResult);
        \u0275\u0275advance();
